...
$(".header").on("click", "a", function (event) {
    ...
    if (cls == "login") {
        $.magnificPopup.open({
            items: {
                src: "<div class='white-popup'><form class='loginPanel'>" + "<input type='text' name='username'  placeholder='Username'><br>" + "<input type='password' name='password' placeholder='Password'><br>" + "<input type='radio' id='autoLogin' name='autoLogin'>" + "<label for='autoLogin'>Remember me</label><br><button>登录</button></form></div>",
                type: 'inline'
            }
        });
    }
